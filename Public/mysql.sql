...
--
-- 表的结构 `ding_addarticle`
--

CREATE TABLE IF NOT EXISTS `ding_addarticle` (
...
--
-- 转存表中的数据 `ding_addarticle`
--

INSERT INTO `ding_addarticle` (`did`, `title_id`, `dwend1`, `dwend2`) VALUES
(1, 14, 'M2M简介1', 'M2M简介2'),
(2, 15, '实时数据库和关系数据库的设计特点1', '实时数据库和关系数据库的设计特点2'),
(3, 16, '朱志祥讲物联网（一）1', '朱志祥讲物联网（一）2'),
(4, 17, '解析M2M：物联网的四大支撑技术之一1', '解析M2M：物联网的四大支撑技术之一2'),
(5, 18, '全网通址 物联网时代手机是什么1', '全网通址 物联网时代手机是什么2'),
(6, 19, '红外线感应器1', '红外线感应器2'),
(7, 20, 'ZigBee技术在物联网系统中的应用研究1', 'ZigBee技术在物联网系统中的应用研究'),
(8, 21, '浅析公共安全监测物联网技术1', '浅析公共安全监测物联网技术2'),
(9, 22, '物联网冰箱1', '物联网冰箱2');
...
CREATE TABLE IF NOT EXISTS `ding_addvideo` (
  `did` int(20) NOT NULL auto_increment,
  `title_id` int(20) unsigned NOT NULL,
  PRIMARY KEY  (`did`)
...
(1, '文档1', 1, 'dwend1', 'varchar', 0, '', '30', 0),
(2, '文档2', 1, 'dwend2', 'varchar', 0, '', '20', 0);
...
INSERT INTO `ding_nav_head` (`id`, `parent_id`, `text`, `path`, `myorder`, `url`) VALUES
(1, 0, '首页', ',', 0, NULL),
(2, 0, '视频教程', ',', 0, 'List/?id=5'),
(3, 0, '开源项目', ',', 0, 'List/?id=28'),
(4, 0, '物联网', ',', 0, 'List/?id=25'),
(5, 0, '推荐书籍', ',', 0, 'List/?id=24'),
(6, 0, '网站建设', ',', 0, 'List/?id=23'),
(7, 0, 'web开发', ',', 0, 'List/?id=14'),
(8, 0, '图形图像', ',', 0, 'List/?id=12'),
(9, 0, '网络资讯', ',', 0, 'List/?id=1'),
(10, 0, '休闲一刻', ',', 0, 'List/?id=31'),
(11, 0, '电商学院', ',', 0, 'List/?id=32'),
(12, 0, '励志一生', ',', 0, 'List/?id=29');
...
(1, 0, '网络', 'wangluo', 1, '', '', '', '', '', ',', 0),
(2, 1, '互联网', 'hulianwang', 1, '', '', '', '', '', ',1,', 0),
(3, 1, '通信', 'tongxin', 1, '', '', '', '', '', ',1,', 0),
(4, 1, 'IT业界', 'ITyejie', 1, '', '', '', '', '', ',1,', 0),
(5, 0, '视频教程', 'shipinjiaocheng', 2, '', '', '', '', '', ',', 0),
(6, 5, 'PHP视频', 'PHPshipin', 2, '', '', '', '', '', ',5,', 0),
(7, 5, 'jQuery/AJAX视频', 'jQuery/AJAXshipin', 2, '', '', '', '', '', ',5,', 0),
(8, 5, '办公软件教程', 'bangongruanjianjiaocheng', 2, '', '', '', '', '', ',5,', 0),
(9, 5, '平面设计', 'pingmiansheji', 2, '', '', '', '', '', ',5,', 0),
(10, 5, '网站制作', 'wangzhanzhizuo', 2, '', '', '', '', '', ',5,', 0),
(11, 5, 'Python视频教程', 'Pythonshipinjiaocheng', 2, '', '', '', '', '', ',5,', 0),
(12, 0, '图形图像', 'tuxingtuxiang', 1, '', '', '', '', '', ',', 0),
(13, 12, 'Photoshop', 'Photoshop', 1, '', '', '', '', '', ',12,', 0),
(14, 0, 'web | 编程开发', 'web | bianchengkaifa', 1, '', '', '', '', '', ',', 0),
(15, 14, 'php教程', 'phpjiaocheng', 1, '', '', '', '', '', ',14,', 0),
(16, 14, 'MySQL', 'MySQL', 1, '', '', '', '', '', ',14,', 0),
(17, 14, 'HTML/CSS', 'HTML/CSS', 1, '', '', '', '', '', ',14,', 0),
(18, 14, 'JQuery教程', 'JQueryjiaocheng', 1, '', '', '', '', '', ',14,', 0),
(19, 14, 'Ruby | Rails', 'Ruby | Rails', 1, '', '', '', '', '', ',14,', 0),
(20, 14, 'Java | Jsp', 'Java | Jsp', 1, '', '', '', '', '', ',14,', 0),
(21, 14, 'Python', 'Python', 1, '', '', '', '', '', ',14,', 0),
(22, 14, '其它', 'qita', 1, '', '', '', '', '', ',14,', 0),
(23, 0, '网站建设', 'wangzhanjianshe', 1, '', '', '', '', '', ',', 0),
(24, 0, '推荐书籍', 'tuijianshuji', 1, '', '', '', '', '', ',', 0),
(25, 0, '物联网', 'wulianwang', 1, '', '', '', '', '', ',', 0),
(26, 25, '物联网资讯', 'wulianwangzixun', 1, '', '', '', '', '', ',25,', 0),
(27, 25, '物联网技术', 'wulianwangjishu', 1, '', '', '', '', '', ',25,', 0),
(28, 0, '开源项目', 'kaiyuanxiangmu', 1, '', '', '', '', '', ',', 0),
(29, 0, '励志一生', 'lizhiyisheng', 1, '', '', '', '', '', ',', 0),
(30, 23, '域名主机', 'yumingzhuji', 1, '', '', '', '', '', ',23,', 0),
(31, 0, '休闲一刻', 'xiuxianyike', 1, '', '', '', '', '', ',', 0),
(32, 0, '电商学院', 'dianshangxueyuan', 1, '', '', '', '', '', ',', 0);
...
(1, 'cfg_sitename', '', '网站名称', 1, 'text', 0),
(2, 'cfg_siteurl', '', '网站地址', 1, 'text', 0),
(3, 'cfg_keywords', '', '关键字', 1, 'text', 0),
(4, 'cfg_description', '', '网站描述', 1, 'text', 0),
(5, 'cfg_defaultpic', 'defaultpic.gif', '默认图片', 1, 'text', 0),
(6, 'cfg_copyright', '© （<a href=\\"http://www.adminsir.net\\">www.adminsir.net</a>）站长先生网--版权所有，并保留所有权利。<br />\r\nPowered by <a href=\\"http://www.dingcms.com\\" target=\\"_blank\\">www.dingcms.com</a><a href=\\"http://webscan.360.cn/index/checkwebsite/url/www.adminsir.net\\"></a>', '版权信息', 1, 'textarea', 0),
(7, '统计信息', '<script src="http://s84.cnzz.com/stat.php?id=3490277&web_id=3490277&show=pic" language="JavaScript"></script>', 'cfg_tongji', 1, 'text', 0),
(8, 'cfg_title', 'Hello world！记录成长的点点滴滴，只因喜欢！', '首页标题', 1, 'text', 0),
(9, 'cfg_website_open', '2', '站点是否关闭', 1, 'radio', 0);
...
CREATE TABLE IF NOT EXISTS `ding_title` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='标题表' AUTO_INCREMENT=23 ;
...
(10, 1, '测试文章10222', '测试文章10', '', NULL, '', '', '', '', '', '', 0, 1355799013, 1355799013, 'true', 'false'),
...
(13, 1, '的的的2', '', '', NULL, '', '', '', '', '', '', 0, 0, 0, 'true', 'false'),
(14, 27, 'M2M简介', 'M2M简介', '', NULL, '', '', '', '', '', '', 0, 0, 0, 'true', 'false'),
(15, 27, '实时数据库和关系数据库的设计特点', '', '', NULL, '', '', '', '', '', '', 1, 0, 0, 'true', 'false'),
(16, 27, '朱志祥讲物联网（一）', '', '', NULL, '', '', '', '', '', '', 1, 0, 0, 'true', 'false'),
(17, 27, '解析M2M：物联网的四大支撑技术之一', '', '', NULL, '', '', '', '', '', '', 1, 0, 0, 'true', 'false'),
(18, 27, '全网通址 物联网时代手机是什么', '', '', NULL, '', '', '', '', '', '', 0, 0, 0, 'true', 'false'),
(19, 27, '红外线感应器', '', '', NULL, '', '', '', '', '', '', 0, 0, 0, 'true', 'false'),
(20, 27, 'ZigBee技术在物联网系统中的应用研究', '', '', NULL, '', '', '', '', '', '', 21, 0, 0, 'true', 'false'),
(21, 27, '浅析公共安全监测物联网技术', '', '', NULL, '', '', '', '', '', '', 0, 0, 0, 'true', 'false'),
(22, 27, '物联网冰箱', '', '', NULL, '', '', '', '', '', '', 2, 0, 0, 'true', 'false');
